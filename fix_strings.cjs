...
// Use regex to find the broken patterns precisely
// Pattern: context.strokeStyle = \gba(255, 215, 0, \)\;
// The \r might be there as a literal or a real CR.
...
console.log("Success: Drawing strings fixed via Node.js");
