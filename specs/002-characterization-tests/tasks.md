...
- [ ] T041 [US1] Design the local-terminal-state fixture in `tests/characterization/scenario-003-fixture-design.md` after the narrowing decision is recorded. (FR-010, SC-007)
- [ ] T042 [US1] Record the controlled observation or deterministic replay evidence for the local-terminal-state subcase in `tests/characterization/scenario-003-replay-evidence.md`; keep the result unpromoted until the owner acceptance step is recorded. (FR-008, FR-009, SC-006, SC-007)
