...
- [x] T047 [US2] Record the preliminary classification and known-bug review for scenario 3 in `tests/characterization/slice-b/scenario-03-classification.md`; stop if the behavior is still `UNCONFIRMED_RUNTIME_BEHAVIOR` or `KNOWN_BUG_DO_NOT_FREEZE`. (FR-008, FR-009, SC-006, SC-008)
