...
- [ ] T048 [US2] Decide whether the construction-completion subcase needs a seam in `tests/characterization/slice-b/scenario-03-seam.md`; request a minimal seam only if the current construction completion boundary cannot be observed without a minimal helper. (FR-007, FR-011, SC-005, SC-006)
- [ ] T049 [US2] Design the frozen timestamp fixture for the construction-completion subcase in `tests/characterization/slice-b/scenario-03-fixture.json` after the seam decision is recorded. (FR-010, SC-007)
- [ ] T050 [US2] Record the controlled observation or deterministic replay evidence for the construction-completion subcase in `tests/characterization/slice-b/scenario-03-replay-evidence.md`; keep the result unpromoted until the owner acceptance step is recorded. (FR-008, FR-009, SC-006, SC-007)
